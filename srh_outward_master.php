    ...
    <div class="container-fluid">
      ...
      <?php
        ...
        <div style="margin-bottom:50px;">
            <button type="button" name="inputCreate" class="btn btn-primary  pull-right text-white" onclick="location.href='frm_outward_master.php'">+ Add New</button>
        </div>
        <?php
            }
        ?>
...
/* MODIFIED BY HETANSHREE FOREIGNKEY DELETE ERROR MESSAGE*/
 if(isset($_SESSION["sess_message_cls"]) && $_SESSION["sess_message_cls"]!="") {
    ...
    echo "<script>
        ...
        if (result.isConfirmed) {location.href='srh_outward_master.php';}
    </script>";
