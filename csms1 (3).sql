...
CREATE TABLE `tbl_rent_invoice_detail` (
  ...
  `rent_invoice_id` bigint(20) UNSIGNED DEFAULT NULL,
  `description` varchar(500) DEFAULT NULL,
...
--
-- Dumping data for table `tbl_rent_invoice_detail`
--

INSERT INTO `tbl_rent_invoice_detail` (`rent_invoice_detail_id`, `rent_invoice_id`, `description`, `qty`, `unit`, `weight`, `rate_per_unit`, `amount`, `remark`, `inward_no`, `inward_date`, `lot_no`, `item`, `marko`, `invoice_qty`, `unit_name`, `wt_per_kg`, `storage_duration`, `rent_per_storage_duration`, `rent_per`, `outward_date`, `charges_from`, `charges_to`, `actual_month`, `actual_day`, `invoice_month`, `invoice_day`, `invoice_amount`, `invoice_for`) VALUES
(1, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, '0000-00-00', 9, 0, 1, 12, 0, 12, 0, 30, 0, '0000-00-00', '0000-00-00', '0000-00-00', 0, 8, 1, 0, 360, 'Outward'),
(2, 5, 'deqw', 33, '100ml', 33.00, 32.00, 45621, 'GBFGC', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(2, 2, 2, '0002/25-26', '2025-06-27', '2025-06-27', 0, 4, 1, 1, 0, '9', 0.00, 0.00, 0.00, 0.00, 0, 0, 0, 0, 0, '', 1, NULL, 1, '2025-06-27 11:07:25', 1, 22),
(3, 2, 3, '0003/25-26', '2025-06-27', '2025-06-27', 0, 4, 1, 1, 0, '9', 0.00, 0.00, 0.00, 0.00, 0, 0, 0, 0, 0, '', 1, NULL, 1, '2025-06-27 12:42:19', 1, 22),
(4, 2, 3, '0003/25-26', '2025-06-27', '2025-06-27', 0, 4, 1, 1, 0, '9', 0.00, 0.00, 0.00, 0.00, 0, 0, 0, 0, 0, '', 1, NULL, 1, '2025-06-27 12:43:10', 1, 22),
(5, 2, 4, '0004/25-26', '2025-06-27', '2025-06-27', 0, 6, 5, 1, 0, 'Select Lot No', 0.00, 0.00, 0.00, 0.00, 0, 0, 0, 0, 0, '', 1, NULL, 1, '2025-06-27 12:44:37', 1, 22);
...
ALTER TABLE `tbl_rent_invoice_detail`
  ...
  ADD KEY `rent_invoice_detail_rent_invoice_id` (`rent_invoice_id`);
...
--
ALTER TABLE `tbl_rent_invoice_master`
  MODIFY `rent_invoice_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Constraints for table `tbl_rent_invoice_detail`
--
ALTER TABLE `tbl_rent_invoice_detail`
  ADD CONSTRAINT `rent_invoice_detail_rent_invoice_id` FOREIGN KEY (`rent_invoice_id`) REFERENCES `tbl_rent_invoice_master` (`rent_invoice_id`);
