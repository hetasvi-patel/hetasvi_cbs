<?php
    include("classes/cls_chamber_master.php");
    ...
    checkFrmPermission($transactionmode,$currentmenu_label,"srh_chamber_master.php");
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-12" style="padding:0;">
       <div class="box box-info">
            <!-- form start -->
            <form id="masterForm" action="classes/cls_chamber_master.php"  method="post" class="form-horizontal needs-validation" enctype="multipart/form-data" novalidate>
                <?php
            ...
            <!-- .box-footer -->
              <div class="box-footer">
                ...
                <input type="button" class="btn btn-primary" id="btn_search" name="btn_search" value="Search" onclick="window.location='srh_chamber_master.php'">
                ...
                <input type="button" class="btn btn-default" id="btn_frm" name="btn_frm" value="Cancel" onclick="window.location='frm_chamber_master.php'">
              </div>
              <!-- /.box-footer -->
        </form>
        <!-- form end -->
...
document.addEventListener("DOMContentLoaded", function () {    
    ...
    function checkDuplicate(input) {
       ...
       let id_column="chamber_id";
       let id_value=document.getElementById(id_column).value;
       $.ajax({
            url: "<?php echo "classes/cls_chamber_master.php"; ?>",
            type: "POST",
            data: { column_name: input.name, column_value:column_value, id_name:id_column,id_value:id_value,table_name:"<?php echo $tbl_chamber_master; ?>",action:"checkDuplicate"},
...
<?php
    frmAlert("frm_chamber_master.php");
?>
<?php
