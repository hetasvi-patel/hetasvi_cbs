    ...
    <div class="container-fluid">
      ...
      <?php
        ...
        <div style="margin-bottom:50px;">
            <button type="button" name="inputCreate" class="btn btn-primary  pull-right text-white" onclick="location.href='frm_rent_invoice_master.php'">+ Add New</button>
        </div>
        <?php
            }
        ?>
...
<?php
    if(isset($_SESSION["sess_message_cls"]) && $_SESSION["sess_message_cls"]!="") {
        echo "<script>result=Swal.fire('".$_SESSION["sess_message_title"]."', '".$_SESSION["sess_message"]."', '".$_SESSION["sess_message_icon"]."');if (result.isConfirmed) {location.href='srh_rent_invoice_master.php';}</script>";
